...
static const struct TrainerMonNoItemCustomMoves sParty_GabbyAndTy6[] = {
    ...
    .personality = NATURE_QUIET,
    .abilityNum = 1,
    .moves = {MOVE_FLASH_CANNON, MOVE_LIGHT_SCREEN, MOVE_TRI_ATTACK, MOVE_THUNDERBOLT}
    },
    {
    .lvl = 50,
    ...
    .personality = NATURE_QUIET,
    .abilityNum = 2,
    .moves = {MOVE_SHADOW_BALL, MOVE_CRUNCH, MOVE_ROCK_SLIDE, MOVE_HYPER_VOICE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ricky2[] = {
    ...
    .personality = PERSONALITY_RANDOM,
    .abilityNum = ABILITY_NUM_DEFAULT,
    .moves = {MOVE_SAND_ATTACK, MOVE_PIN_MISSILE, MOVE_HEADBUTT, MOVE_SURF}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ricky3[] = {
    ...
    .personality = PERSONALITY_RANDOM,
    .abilityNum = ABILITY_NUM_DEFAULT,
    .moves = {MOVE_THUNDERBOLT, MOVE_PIN_MISSILE, MOVE_HEADBUTT, MOVE_SURF}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ricky4[] = {
    ...
    .personality = PERSONALITY_RANDOM,
    .abilityNum = ABILITY_NUM_DEFAULT,
    .moves = {MOVE_SUCKER_PUNCH, MOVE_ICE_BEAM, MOVE_FACADE, MOVE_SHADOW_BALL}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ricky5[] = {
    ...
    .personality = PERSONALITY_RANDOM,
    .abilityNum = ABILITY_NUM_DEFAULT,
    .moves = {MOVE_SUPER_FANG, MOVE_U_TURN, MOVE_IRON_TAIL, MOVE_DIG}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Braxton[] = {
    ...
    .personality = PERSONALITY_RANDOM,
    .abilityNum = ABILITY_NUM_DEFAULT,
    .moves = {MOVE_ROOST, MOVE_QUICK_ATTACK, MOVE_AERIAL_ACE, MOVE_ENDEAVOR}
    },
    {
    .lvl = 28,
    .species = SPECIES_TRAPINCH,
    ...
    .personality = PERSONALITY_RANDOM,
    .abilityNum = ABILITY_NUM_DEFAULT,
    .moves = {MOVE_HEAVY_SLAM, MOVE_BRINE, MOVE_REST, MOVE_WATER_PULSE}
    },
    {
    .lvl = 28,
    .species = SPECIES_MAGNETON,
    .personality = PERSONALITY_RANDOM,
    .abilityNum = ABILITY_NUM_DEFAULT,
    .moves = {MOVE_THUNDERBOLT, MOVE_SUPERSONIC, MOVE_THUNDER_WAVE, MOVE_MAGNET_BOMB}
    },
    {
    .lvl = 28,
    .species = SPECIES_SHIFTRY,
...
static const struct TrainerMonItemCustomMoves sParty_Alexia[] = {
    ...
    .abilityNum = ABILITY_NUM_DEFAULT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DEFENSE_CURL, MOVE_BODY_SLAM, MOVE_SHADOW_BALL, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Wendy[] = {
    ...
    .personality = PERSONALITY_RANDOM,
    .abilityNum = ABILITY_NUM_DEFAULT,
    .moves = {MOVE_BATON_PASS, MOVE_SUCKER_PUNCH, MOVE_IRON_DEFENSE, MOVE_FAIRY_WIND}
    },
    {
    .lvl = 29,
    .species = SPECIES_ROSELIA,
...
static const struct TrainerMonItemCustomMoves sParty_Daphne[] = {
    ...
    .moves = {MOVE_ATTRACT, MOVE_SWEET_KISS, MOVE_FLAIL, MOVE_SCALD}
    },
    {
    .lvl = 39,
    .species = SPECIES_LUVDISC,
    ...
    .abilityNum = ABILITY_NUM_DEFAULT,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_ATTRACT, MOVE_SAFEGUARD, MOVE_TAKE_DOWN, MOVE_SCALD}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Olivia[] = {
    ...
    .personality = PERSONALITY_RANDOM,
    .abilityNum = ABILITY_NUM_DEFAULT,
    .moves = {MOVE_IRON_DEFENSE, MOVE_DRAINING_KISS, MOVE_AMNESIA, MOVE_SCALD}
    },
    {
    .lvl = 37,
    ...
    .personality = PERSONALITY_RANDOM,
    .abilityNum = ABILITY_NUM_DEFAULT,
    .moves = {MOVE_TAUNT, MOVE_DOUBLE_HIT, MOVE_SCALD, MOVE_NIGHT_SLASH}
    },
    {
    .lvl = 39,
    .species = SPECIES_LUDICOLO,
    .personality = PERSONALITY_RANDOM,
    .abilityNum = ABILITY_NUM_DEFAULT,
    .moves = {MOVE_UPROAR, MOVE_GIGA_DRAIN, MOVE_FAKE_OUT, MOVE_SCALD}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Jessica1[] = {
    ...
    .personality = PERSONALITY_RANDOM,
    .abilityNum = ABILITY_NUM_DEFAULT,
    .moves = {MOVE_POISON_FANG, MOVE_SCREECH, MOVE_GLARE, MOVE_NIGHT_SLASH}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Jessica4[] = {
    ...
    .personality = PERSONALITY_RANDOM,
    .abilityNum = ABILITY_NUM_DEFAULT,
    .moves = {MOVE_LEECH_SEED, MOVE_PSYBEAM, MOVE_SOLAR_BEAM, MOVE_SLEEP_POWDER}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Jessica5[] = {
    ...
    .personality = PERSONALITY_RANDOM,
    .abilityNum = ABILITY_NUM_DEFAULT,
    .moves = {MOVE_POISON_FANG, MOVE_COIL, MOVE_GLARE, MOVE_NIGHT_SLASH}
    },
    {
    .lvl = 45,
    .species = SPECIES_EXEGGUTOR,
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .abilityNum = 0,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_IRON_TAIL, MOVE_PLAY_ROUGH, MOVE_TAUNT, MOVE_CRUNCH}
    },
    {
    .lvl = 48,
    .species = SPECIES_SHIFTRY,
    ...
    .abilityNum = 1,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_KNOCK_OFF, MOVE_ROCK_SLIDE, MOVE_SEED_BOMB, MOVE_SWORDS_DANCE}
    },
    {
    .lvl = 46,
    .species = SPECIES_CACTURNE,
    .personality = NATURE_MILD,
    .abilityNum = 2,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_LEECH_SEED, MOVE_DARK_PULSE, MOVE_GIGA_DRAIN, MOVE_SPIKES}
    },
    {
    .lvl = 48,
    .species = SPECIES_CRAWDAUNT,
    ...
    .abilityNum = 0,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CRABHAMMER, MOVE_SWORDS_DANCE, MOVE_SUPERPOWER, MOVE_AQUA_JET}
    },
    {
    .lvl = 49,
    ...
    .abilityNum = 0,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PURSUIT, MOVE_SUCKER_PUNCH, MOVE_SWORDS_DANCE, MOVE_PLAY_ROUGH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .abilityNum = 0,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_CALM_MIND, MOVE_REST, MOVE_SHADOW_BALL, MOVE_PROTECT}
    },
    {
    .lvl = 49,
    .species = SPECIES_BANETTE,
    ...
    .abilityNum = 2,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SUCKER_PUNCH, MOVE_SHADOW_CLAW, MOVE_DAZZLING_GLEAM, MOVE_WILL_O_WISP}
    },
    {
    .lvl = 50,
    .species = SPECIES_SABLEYE,
    .personality = NATURE_CAREFUL,
    .abilityNum = 2,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_RECOVER, MOVE_FAKE_OUT, MOVE_FOUL_PLAY, MOVE_TAUNT}
    },
    {
    .lvl = 49,
    ...
    .abilityNum = 0,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HEX, MOVE_WILL_O_WISP, MOVE_PAIN_SPLIT, MOVE_THUNDER_WAVE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .abilityNum = 2,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SPIKES, MOVE_ICE_SHARD, MOVE_EXPLOSION, MOVE_HAIL}
    },
    {
    .lvl = 50,
    ...
    .abilityNum = 2,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_STEALTH_ROCK, MOVE_ICICLE_CRASH, MOVE_EARTHQUAKE, MOVE_CURSE}
    },
    {
    .lvl = 52,
    ...
    .abilityNum = 0,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_FREEZE_DRY, MOVE_HYDRO_PUMP, MOVE_PERISH_SONG, MOVE_THUNDERBOLT}
    },
    {
    .lvl = 52,
    ...
    .abilityNum = 2,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_KNOCK_OFF, MOVE_ICICLE_CRASH, MOVE_LOW_KICK, MOVE_PURSUIT}
    },
    {
    .lvl = 53,
    ...
    .abilityNum = 1,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SURF, MOVE_TOXIC, MOVE_BLIZZARD, MOVE_HAIL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .abilityNum = 0,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_DAZZLING_GLEAM, MOVE_ROOST, MOVE_DRAGON_DANCE, MOVE_DRAGON_CLAW}
    },
    {
    .lvl = 55,
    ...
    .abilityNum = 2,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OUTRAGE, MOVE_EXTREME_SPEED, MOVE_EARTHQUAKE, MOVE_DRAGON_DANCE}
    },
    {
    .lvl = 52,
    ...
    .abilityNum = 0,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_CLAW, MOVE_CRUNCH, MOVE_U_TURN, MOVE_EARTHQUAKE}
    },
    {
    .lvl = 55,
    ...
    .abilityNum = 0,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FLAMETHROWER, MOVE_DRAGON_CLAW, MOVE_ROCK_SLIDE, MOVE_ROOST}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .abilityNum = 1,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_THROW, MOVE_CURSE, MOVE_BIND, MOVE_ROCK_TOMB}
    },
    {
    .lvl = 15,
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .abilityNum = 2,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SCALD, MOVE_ATTRACT, MOVE_SWEET_KISS, MOVE_RAIN_DANCE}
    },
    {
    .lvl = 41,
    .species = SPECIES_WHISCASH,
...
static const struct TrainerMonNoItemCustomMoves sParty_Katelynn[] = {
    ...
    .personality = PERSONALITY_RANDOM,
    .abilityNum = ABILITY_NUM_DEFAULT,
    .moves = {MOVE_SKILL_SWAP, MOVE_PSYCHIC, MOVE_DRAINING_KISS, MOVE_CALM_MIND}
    },
    {
    .lvl = 43,
    .species = SPECIES_SLAKING,
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .abilityNum = 1,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BARRIER, MOVE_HYDRO_PUMP, MOVE_SLUDGE_BOMB, MOVE_TOXIC_SPIKES}
    },
    {
    .lvl = 56,
    .species = SPECIES_LUDICOLO,
    ...
    .abilityNum = 1,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_GIGA_DRAIN, MOVE_SURF, MOVE_LEECH_SEED, MOVE_KNOCK_OFF}
    },
    {
    .lvl = 56,
    .species = SPECIES_WHISCASH,
    ...
    .abilityNum = 2,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_WATERFALL, MOVE_DRAGON_DANCE, MOVE_STONE_EDGE}
    },
    {
    .lvl = 56,
    .species = SPECIES_GYARADOS,
    ...
    .abilityNum = 0,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_RECOVER, MOVE_SCALD, MOVE_ICE_BEAM, MOVE_HAZE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Aaron[] = {
    ...
    .personality = PERSONALITY_RANDOM,
    .abilityNum = ABILITY_NUM_DEFAULT,
    .moves = {MOVE_DRAGON_BREATH, MOVE_HEADBUTT, MOVE_PROTECT, MOVE_FLAMETHROWER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Dianne[] = {
    ...
    .abilityNum = ABILITY_NUM_DEFAULT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDERBOLT, MOVE_CONFUSE_RAY, MOVE_BUBBLE_BEAM, MOVE_SIGNAL_BEAM}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline3[] = {
    ...
    .personality = PERSONALITY_RANDOM,
    .abilityNum = ABILITY_NUM_DEFAULT,
    .moves = {MOVE_LAVA_PLUME, MOVE_TAKE_DOWN, MOVE_MAGNITUDE, MOVE_SUNNY_DAY}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline4[] = {
    ...
    .personality = PERSONALITY_RANDOM,
    .abilityNum = ABILITY_NUM_DEFAULT,
    .moves = {MOVE_MOONBLAST, MOVE_MOONLIGHT, MOVE_METRONOME, MOVE_COSMIC_POWER}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_GinaAndMia2[] = { // unused
    {
    .lvl = 10,
    .species = SPECIES_DUSKULL,
    .personality = PERSONALITY_RANDOM,
...
static const struct TrainerMonNoItemDefaultMoves sParty_AmyAndLiv3[] = { // unused
    {
    .lvl = 27,
    .species = SPECIES_PLUSLE,
    .personality = PERSONALITY_RANDOM,
...
static const struct TrainerMonItemCustomMoves sParty_Annika[] = {
    ...
    .abilityNum = ABILITY_NUM_DEFAULT,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_FLAIL, MOVE_SCALD, MOVE_RETURN, MOVE_ATTRACT}
    },
    {
    .lvl = 39,
    .species = SPECIES_FEEBAS,
...
static const struct TrainerMonNoItemCustomMoves sParty_RivalLilycoveMudkip[] = {
    {
    .lvl = 35,
    .species = SPECIES_AMPHAROS,
    .personality = PERSONALITY_RANDOM,
...
static const struct TrainerMonNoItemCustomMoves sParty_RivalLilycoveTreecko[] = {
    {
    .lvl = 35,
    .species = SPECIES_AMPHAROS,
    .personality = PERSONALITY_RANDOM,
...
static const struct TrainerMonNoItemCustomMoves sParty_RivalLilycoveTorchic[] = {
    {
    .lvl = 35,
    .species = SPECIES_AMPHAROS,
    .personality = PERSONALITY_RANDOM,
...
static const struct TrainerMonNoItemCustomMoves sParty_Athena[] = {
    {
    .lvl = 32,
    .species = SPECIES_MANECTRIC,
    .personality = PERSONALITY_RANDOM,
    .abilityNum = ABILITY_NUM_DEFAULT,
    .moves = {MOVE_THUNDER, MOVE_THUNDER_WAVE, MOVE_QUICK_ATTACK, MOVE_RAIN_DANCE}
    },
    {
    .lvl = 32,
    .species = SPECIES_LINOONE,
    .personality = PERSONALITY_RANDOM,
    .abilityNum = ABILITY_NUM_DEFAULT,
    .moves = {MOVE_SURF, MOVE_THIEF, MOVE_BABY_DOLL_EYES, MOVE_HEADBUTT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Lucas2[] = {
    ...
    .personality = PERSONALITY_RANDOM,
    .abilityNum = ABILITY_NUM_DEFAULT,
    .moves = {MOVE_SPLASH, MOVE_WATER_GUN, MOVE_ASTONISH, MOVE_GROWL}
    }
};

static const struct TrainerMonNoItemDefaultMoves sParty_Mike1[] = { // Unused
    {
    .lvl = 10,
    .species = SPECIES_PELIPPER,
    .personality = PERSONALITY_RANDOM,
...
static const struct TrainerMonNoItemCustomMoves sParty_Hideo[] = {
    ...
    .personality = PERSONALITY_RANDOM,
    .abilityNum = ABILITY_NUM_DEFAULT,
    .moves = {MOVE_POUND, MOVE_POISON_GAS, MOVE_SLUDGE, MOVE_HARDEN}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR2[] = {
    ...
    .personality = PERSONALITY_RANDOM,
    .abilityNum = 2,
    .moves = {MOVE_LAVA_PLUME, MOVE_FOCUS_BLAST, MOVE_EXTRASENSORY, MOVE_WILL_O_WISP}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_MelAndPaul[] = {
    ...
    .personality = PERSONALITY_RANDOM,
    .abilityNum = ABILITY_NUM_DEFAULT,
    .moves = {MOVE_MOONLIGHT, MOVE_SILVER_WIND, MOVE_TOXIC, MOVE_PROTECT}
    },
    {
    .lvl = 27,
    .species = SPECIES_BEAUTIFLY,
    .personality = PERSONALITY_RANDOM,
    .abilityNum = ABILITY_NUM_DEFAULT,
    .moves = {MOVE_SILVER_WIND, MOVE_MEGA_DRAIN, MOVE_ATTRACT, MOVE_AIR_CUTTER}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Leonel[] = {
    ...
    .personality = PERSONALITY_RANDOM,
    .abilityNum = ABILITY_NUM_DEFAULT,
    .moves = {MOVE_THUNDER, MOVE_QUICK_ATTACK, MOVE_THUNDER_WAVE, MOVE_RAIN_DANCE}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_RivalLinkPlaceholder[] = {
    {
    .lvl = 5,
