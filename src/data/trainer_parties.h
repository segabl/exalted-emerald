...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .abilityNum = 0,
    .heldItem = ITEM_NONE,
    .moves = MOVE_CRABHAMMER, MOVE_SWORDS_DANCE, MOVE_STRENGTH, MOVE_FACADE
    },
    {
    .iv = 30,
    .lvl = 49,
    ...
    .abilityNum = 1,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = MOVE_AERIAL_ACE, MOVE_SUCKER_PUNCH, MOVE_SWORDS_DANCE, MOVE_SLASH
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .abilityNum = 2,
    .heldItem = ITEM_NONE,
    .moves = MOVE_SNATCH, MOVE_SHADOW_SNEAK, MOVE_SUCKER_PUNCH, MOVE_SHADOW_CLAW
    },
    {
    .iv = 30,
    .lvl = 50,
    ...
    .abilityNum = 2,
    .heldItem = ITEM_NONE,
    .moves = MOVE_CONFUSE_RAY, MOVE_FAKE_OUT, MOVE_FOUL_PLAY, MOVE_WILL_O_WISP
    },
    {
    .iv = 30,
    .lvl = 49,
    ...
    .abilityNum = 2,
    .heldItem = ITEM_NONE,
    .moves = MOVE_SNATCH, MOVE_SHADOW_BALL, MOVE_PSYCHIC, MOVE_THUNDERBOLT
    },
    {
    .iv = 30,
    .lvl = 51,
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .abilityNum = 1,
    .heldItem = ITEM_NONE,
    .moves = MOVE_LIGHT_SCREEN, MOVE_HAIL, MOVE_ICY_WIND, MOVE_ICE_FANG
    },
    {
    .iv = 30,
    .lvl = 52,
    ...
    .abilityNum = 1,
    .heldItem = ITEM_NONE,
    .moves = MOVE_REFLECT, MOVE_HAIL, MOVE_ICY_WIND, MOVE_ICE_FANG
    },
    {
    .iv = 30,
    .lvl = 53,
    ...
    .abilityNum = 1,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = MOVE_SURF, MOVE_BODY_SLAM, MOVE_BLIZZARD, MOVE_HAIL
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .abilityNum = 1,
    .heldItem = ITEM_NONE,
    .moves = MOVE_RAIN_DANCE, MOVE_WATER_SPOUT, MOVE_REST, MOVE_BLIZZARD
    },
    {
    .iv = 3,
    .lvl = 55,
    ...
    .abilityNum = 2,
    .heldItem = ITEM_NONE,
    .moves = MOVE_BARRIER, MOVE_HYDRO_PUMP, MOVE_SLUDGE_BOMB, MOVE_ICE_BEAM
    },
    {
    .iv = 3,
    .lvl = 56,
    ...
    .abilityNum = 0,
    .heldItem = ITEM_NONE,
    .moves = MOVE_DRAGON_DANCE, MOVE_EARTHQUAKE, MOVE_THRASH, MOVE_WATERFALL
    },
    {
    .iv = 3,
    .lvl = 58,
