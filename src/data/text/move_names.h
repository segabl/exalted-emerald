const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_HYPERSPACE_HOLE] = _("HSPACE HOLE"),
    [MOVE_WATER_SHURIKEN] = _("SHURIKEN"),
    ...
    [MOVE_ELECTRIC_TERRAIN] = _("SPARKTERRAIN"),
    [MOVE_DAZZLING_GLEAM] = _("DAZZLE"),
    ...
    [MOVE_HYPERSPACE_FURY] = _("HSPACE FURY"),
    [MOVE_SHORE_UP] = _("SHORE UP"),
    [MOVE_FIRST_IMPRESSION] = _("IMPRESSION"),
    ...
    [MOVE_REVELATION_DANCE] = _("REVELATION"),
    ...
    [MOVE_STOMPING_TANTRUM] = _("TANTRUM"),
    ...
    [MOVE_SPECTRAL_THIEF] = _("SPEC THIEF"),
    [MOVE_SUNSTEEL_STRIKE] = _("SUN STRIKE"),
    [MOVE_MOONGEIST_BEAM] = _("MOON BEAM"),
