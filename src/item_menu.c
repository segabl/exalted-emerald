...
void PrepareBagForWallyTutorial(void)
{
    ...
    memcpy(sTempWallyBag->bagPocket_Items, gSaveBlock1Ptr->bagPocket_Items, sizeof(sTempWallyBag->bagPocket_Items));
    memcpy(sTempWallyBag->bagPocket_PokeBalls, gBagPocketPokeBalls, sizeof(sTempWallyBag->bagPocket_PokeBalls));
    ...
    ClearItemSlots(gBagPocketPokeBalls, BAG_POKEBALLS_COUNT);
...
void RestoreBagAfterWallyTutorial(void)
{
    ...
    memcpy(gBagPocketPokeBalls, sTempWallyBag->bagPocket_PokeBalls, sizeof(sTempWallyBag->bagPocket_PokeBalls));
