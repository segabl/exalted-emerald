...
static void CB2_CreateTradeMenu(void)
{
    ...
    case 7:
        ...
        for (i = 0; i < sTradeMenuData->partyCounts[TRADE_PLAYER]; i++)
        {
            ...
            sTradeMenuData->partySpriteIds[TRADE_PLAYER][i] = CreateMonIcon(GetMonData(mon, MON_DATA_SPECIES_EGG),
                                                         SpriteCB_MonIcon,
        ...
        for (i = 0; i < sTradeMenuData->partyCounts[TRADE_PARTNER]; i++)
        {
            ...
            sTradeMenuData->partySpriteIds[TRADE_PARTNER][i] = CreateMonIcon(GetMonData(mon, MON_DATA_SPECIES_EGG, NULL),
                                                         SpriteCB_MonIcon,
...
static void CB2_ReturnToTradeMenu(void)
{
    ...
    case 7:
        ...
        {
            struct Pokemon *mon = &gPlayerParty[i];
            sTradeMenuData->partySpriteIds[TRADE_PLAYER][i] = CreateMonIcon(GetMonData(mon, MON_DATA_SPECIES_EGG, NULL),
                                                         SpriteCB_MonIcon,
                                                         (sTradeMonSpriteCoords[i][0] * 8) + 14,
                                                         (sTradeMonSpriteCoords[i][1] * 8) - 12,
                                                         1,
...
static u32 CanTradeSelectedMon(struct Pokemon *playerParty, int partyCount, int monIdx)
{
    ...
    {
        species2[i] = GetMonData(&playerParty[i], MON_DATA_SPECIES_EGG);
...
int CanSpinTradeMon(struct Pokemon *mon, u16 monIdx)
{
    ...
    {
        speciesArray[i] = GetMonData(&mon[i], MON_DATA_SPECIES_EGG);
...
static void LoadTradeMonPic(u8 whichParty, u8 state)
{
    ...
    {
    case 0:
        species = GetMonData(mon, MON_DATA_SPECIES_EGG);
