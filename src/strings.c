...
const u8 gText_Var1Var2IsItThatllBeVar3[] = _("{STR_VAR_1} {STR_VAR_2}, is it?\nThat'll be ¥{STR_VAR_3}. Do you want it?");
...
const u8 gText_OptionMenuCancel[] = _("BACK");
...
const u8 gText_RunModeNormal[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}NORMAL");
const u8 gText_RunModeInverted[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}INVERTED");
...
const u8 gText_TradeSimulationOT[] = _("SCIENTIST");
...
const u8 gText_RngSeed[] = _("RANDOMIZER SEED");
