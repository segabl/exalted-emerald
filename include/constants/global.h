...
#define MAX_MON_MOVES_LEVELUP 27 // Max amount of level up moves on any mon
#define MAX_MON_MOVES_EGG 18  // Max amount of egg moves on any mon
...
#define OPTIONS_RUN_MODE_NORMAL 0
#define OPTIONS_RUN_MODE_INVERTED 1
